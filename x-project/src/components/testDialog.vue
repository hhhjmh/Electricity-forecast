...
<template>
  <div>
    ...
    <el-dialog title="电能在线" :visible.sync="centerDialogVisible" width="70%"
...
#main_sidebar{
  ...
  box-shadow: 1.5rem 0 2rem -1rem rgba(43, 82, 255, 1.0);
}
...
@keyframes slide-right {
  ...
  100% {
    -webkit-transform: translateX(20.5rem);
            ...
            box-shadow: 1.5rem 0 2rem -1rem rgba(76, 143, 143, 1.0);
